 ...
 */
{
  ...
  "def": {
    ...
    "hpSpotted": {
      "$ref": { "path":"def.vtypeSpotted" },
      "format": "<font face='XVMSymbol' size='15' color='{{.minimap.labelsData.colors.dot.{{sys-color-key}}}}'>{{hp-ratio<25.5?&#x101;}}</font>"
    },
    // HP, visible, spotted
    ...
    "hpX-spotted": {
      "$ref": { "path":"def.vtypeSpotted" },
      "alpha": "{{x-spotted?100|0}}",
      "format": "<font face='XVMSymbol' size='15' alpha='#00'>{{hp-ratio<25.5?&#x101;}}</font>",
      "shadow": { "$ref": { "path":"def.defaultItem.shadow" }, "color": "0xFFBB00", "alpha": 100, "blur": 3, "strength": 6 }
    },
    // Squad, visible
    // Взвод, видимый
    ...
    "rating": {
      ...
      "x": 4.5,
      "y": -1,
      "format": "<font face='XVMSymbol' size='{{xvm-stat?5|0}}' color='{{c:r|#DBDBDB}}'>{{ally?&#x21;|&#x22;}}</font>"
    },
    ...
    "hpLost": {
      ...
      "format": "<font face='XVMSymbol' size='15' color='{{.minimap.labelsData.colors.lostDot.{{sys-color-key}}}}'>{{hp-ratio<25.5?&#x101;}}</font>"
    },
