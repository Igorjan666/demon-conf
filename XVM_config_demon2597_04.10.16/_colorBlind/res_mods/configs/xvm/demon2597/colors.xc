 ...
 */
{
  ...
  "damage": {
    ...
    "eff": [
      { "value": 615,  "color": ${ "def.color1" } },
      { "value": 870,  "color": ${ "def.color2" } },
      { "value": 1175, "color": ${ "def.color3" } },
      { "value": 1525, "color": ${ "def.color4" } },
      { "value": 1850, "color": ${ "def.color5" } },
      { "value": 9999, "color": ${ "def.color6" } } 
    ],
    // Dynamic color by WN6 rating
    // Динамический цвет по рейтингу WN6
    "wn6": [
      { "value": 460,  "color": ${ "def.color1" } },
      { "value": 850,  "color": ${ "def.color2" } },
      { "value": 1215, "color": ${ "def.color3" } },
      { "value": 1620, "color": ${ "def.color4" } },
      { "value": 1960, "color": ${ "def.color5" } },
      { "value": 9999, "color": ${ "def.color6" } }
    ],
    // Dynamic color by WN8 rating
    // Динамический цвет по рейтингу WN8
    "wn8": [
      { "value": 380,  "color": ${ "def.color1" } },
      { "value": 860,  "color": ${ "def.color2" } },
      { "value": 1420, "color": ${ "def.color3" } },
      { "value": 2105, "color": ${ "def.color4" } },
      { "value": 2770, "color": ${ "def.color5" } },
      { "value": 9999, "color": ${ "def.color6" } }
    ],
    // Dynamic color by WG rating
    // Динамический цвет по рейтингу WG
    "wgr": [
      { "value": 2495,  "color": ${ "def.color1" } },
      { "value": 4345,  "color": ${ "def.color2" } },
      { "value": 6425,  "color": ${ "def.color3" } },
      { "value": 8625,  "color": ${ "def.color4" } },
      { "value": 10040, "color": ${ "def.color5" } },
